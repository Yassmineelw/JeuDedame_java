...
public class      VuePartieReseauFX 
       extends    VuePartieFX 
       implements VuePartieReseau {
	...
	final private int[][] winningPositions = { { 1, 5, 9 }, { 3, 5, 7 }, { 1, 2, 3 }, { 4, 5, 6 }, { 7, 8, 9 },
			{ 1, 4, 7 }, { 2, 5, 8 }, { 3, 6, 9 } };
	...
	public void endGame() {
		...
		if (Locale.getDefault() == Locale.CANADA_FRENCH) {
			...
			if (this.tie == true) {
				this.lblMessages.setText("ÉGALITÉ!");
			} else if (String.valueOf(this.winningTeam).equals("O")) {
				this.lblMessages.setText("VICTOIRE!");
			} else if (String.valueOf(this.winningTeam).equals("X")) {
				this.lblMessages.setText("PERDU!");
			}
		} else {

			if (this.tie == true) {
				this.lblMessages.setText("TIE!");
			} else if (String.valueOf(this.winningTeam).equals("O")) {
